...
struct QuestionModel
{
    ...
    let allQuestions: [[String:String]] = [
        ...
        ["question":"Which country has most recently won consecutive World Cups in Soccer?","answers":"Brazil", "option01":"Italy","option02":"Spain","option03":"Argentina", "option04":"Brazil"],
